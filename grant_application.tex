...
Our \textbf{long-term goal} is to establish patient-specific Digital Twins (DTs) as decision-support in cardiovascular surgery. Our \textbf{objective} is to build a DT for each of \textasciitilde{}50 children per year in our BiV repair program, borderline left or right, and test it retrospectively against each child's course. Each DT is built from magnetic resonance imaging with simultaneous pressure measurement (iCMR), and the planned surgery is performed {\it in silico}. Our teams' 3D DTs personalized therapy\cite{sermesant2012_CRTmodeling,chabiniok_BMMB2012} and captured whole-heart contraction\cite{pfaller19a}, yet none entered clinical practice. To give clinicians a tool they actually use, we deliberately build the diagnostic DT in 0D, a spherical approximation of the 3D ventricle: created on-the-fly during the exam, retaining tissue behavior\cite{caruel13}, and proven in clinical proof-of-concepts\cite{ruijsink20,gusseva21a,gusseva25}. We will compare DT parameters with repair success, predicted hemodynamics with the post-operative course, and predicted growth in volume, mass, and wall thickness with the 8--15-month follow-up. Our \textbf{central hypothesis} is that \bfit{DT-derived functional parameters, reflecting myocardial health and resilience, identify the children who benefit from BiV conversion better than today's volume and pressure criteria.} Children's Health at the University of Texas Southwestern Medical Center, one of few US centers with routine iCMR\cite{reddy2020_iCMR} and extensive DT experience\cite{chabiniok17,gusseva21,gusseva25a}, pioneered complex BiV repair, and Yale built the growth model\cite{gebauer23,gebauer24}.

\aim{1}{Quantify each patient's cardiovascular physiology before surgery}{
We hypothesize that DT-derived myocardial stiffness and contractility correlate better with successful BiV repair than the measured volume and pressure. The pressure, volume, and outflow data yield A) the standard clinical metrics, end-diastolic volume and pressure, B) ventricular work and ventricular and arterial elastance, surrogates of contractility and circulation resistance, and C) myocardial stiffness and contractility from the DT created on-the-fly during the exam. This aim delivers selection criteria built on capability, not size.
}
...
The project unites two firsts: on-the-fly physiology assessment and a mechanistic forecast of ventricular growth. \bfit{If successful, it replaces heuristic cut-offs with validated, physiology-based selection and timing of BiV conversion: children who can sustain two ventricles escape the Fontan, and children who would not are spared futile operations.} The approach is built to translate: the DT runs on routine iCMR data during the exam. The validated DTs and criteria will anchor a future clinical trial toward digital twins guiding surgical planning.
...
A subgroup of patients with SVHD is described as with a ventricle of ``borderline size''. Even though the ventricular size plays a substantial role in the heart function (we would typically think of ventricles with end-diastolic volume indexed to body surface area iEDV 25-40 ml/m$^2$), the borderline ventricle represents rather a spectrum\cite{lam2025_borderlineVentricleReview}. In addition to the ventricular volume, also size of ventricular septal defect, diameter of valves etc. need to be considered.  Patients with a borderline-size ventricle historically underwent single-ventricle palliation, with all the long-term adverse effects associated with the Fontan circulation. 

The new surgical approaches, such as complex biventricular (BiV) repair\cite{andersen2020_BiVrepair}, represent a novel approach pioneered in the leading institutes, including the Heart Center at the Children's Health, University of Texas Southwestern Medical Center Dallas -- the site of the PI and of the clinical part of the investigative team. It consists of the ventricular septation and separation of systemic and pulmonary circulations. While development of desired BiV physiology potentially avoids the long-term complications of the single-ventricle palliation, the BiV repair has intrinsic risks related to the failure of the borderline-size ventricle to sustain the circulation. While some patients would directly benefit from the BiV repair, in some other patients postponing the septation and overloading the borderline ventricle (typically by increasing flow through the chamber) could induce growth of the ventricle -- the so-called ventricular recruitment procedure (VR). Those with a positive outcome of the recruitment procedure could be in a better position for the final BiV repair.  
...
The associated heavy computations when using 3D biomechanical models  and technical difficulty in setting up the complex models, in practice, reduce the potential of deploying such methods for large-scale clinical studies, as experienced by our investigative team\cite{sermesant2012_CRTmodeling,chabiniok_BMMB2012,pfaller19a}. 
Under the assumptions of a cylindrical or spherical geometry, a 3D biomechanical model of heart ventricle can be simplified. Such a geometry and kinematics reduction, while the constitutive relations keeping as in the full 3D model \cite{chapelle_energy-preserving_2012}, was performed, e.g., in works\cite{genet2023_cylindricalModel,caruel13}. We previously demonstrated that the geometry-reduced biomechanical models can provide mechanistic insight into heart failure \cite{ruijsink20},  structural heart disease \cite{gusseva21}, surgical intervention planning \cite{gusseva21a,gusseva25},  or physiological monitoring (e.g., hemodynamic stability assessment or response to inotropic agents \cite{le_gall_monitoring_2020}). In several works supervised by the PI, it was shown that it is technically feasible for  medical doctors to run such models\cite{ruijsink20,ruijsink2019_FIMH,le_gall_monitoring_2020,legall19,waugh2021_FIMH}. In these project, the deep insight of medical doctors into the actual physiological and clinical aspects allowed for invaluable modifications of the problem-specific modeling framework, and their subsequent interpretation of the results was crucial for actual clinical translations of novel techniques. 
...
We will employ the biomechanical heart model of a reduced geometry and kinematics\cite{caruel13}. This model was previously used in our clinical research projects\cite{ruijsink20,le_gall_monitoring_2020,gusseva23,gusseva25}. Ventricular geometry and kinematics are reduced to a sphere with inner radius $R$ and wall thickness $d$. %(Figure \ref{fig:schematics}). 
...
\begin{figure}%[t!]
    \centering
%\subfigure[DORV to aorta and MPA]%{\includegraphics[width=0.49\columnwidth]{figures/schematics/circuits/circuit1.png}}    
%\subfigure[DORV to aorta, with Glenn connection]{\includegraphics[width=0.49\columnwidth]{figures/schematics/circuits/circuit2.png}}   
%\subfigure[DORV to aorta, with Glenn connection and AP collaterals]{\includegraphics[width=0.49\columnwidth]{figures/schematics/circuits/circuit3.png}}   
%\subfigure[DORV to aorta, MPA, with Glenn connection]{\includegraphics[width=0.49\columnwidth]{figures/schematics/circuits/circuit4.png}}   
\includegraphics[width=.83\columnwidth]{figures/schematics/circuits/DORV_diagrams_v1s.png}
    \caption{\textbf{Typical circulation configurations in the patients with double-outlet right ventricle (DORV) prior to biventricular repair.} MPA, main pulmonary artery; AP, aorto-pulmonary; Glenn connection, superior vena cava-to-pulmonary artery anastomosis.} 
...
\subsubsection{Aim 2: Post-surgery risk assessed by \textit{In silico} Biventricular Repair Surgery}
...
Independently of this project, we aim to collaborate with other centers performing BiV repair -- such as Boston Children’s as in our recent joint works\cite{gusseva2023_timeSynch_JMRI,gusseva25a}; Duke (with active collaboration of the Dr. Andersen (Director of the Complex BiV Repair program at UT Southwestern, Dallas and Co-Investigator of this project) and Dr. Turek (Duke)); and other centers. Creating such a network will be invaluable, particularly in the next step of extending the work to the multi-center study. 
