...
\textbf{SPECIFIC AIMS} -- About 1 in 2,000 US newborns has single-ventricle heart disease and historically undergoes staged palliation toward the Fontan circulation\cite{khairy2007_univentricularHeart}. The Fontan circulation is palliative, not curative: the single ventricle pumps to both circulations, and many patients progress to heart failure, multi-organ disease, and transplant evaluation as young adults\cite{khairy2008_longtermSurvivalFontan}. For children with a borderline-size ventricle, leading centers, including ours, have pioneered complex biventricular (BiV) repair: the ventricles are septated and the circulations separated\cite{andersen2020_BiVrepair}. If the ventricle is too small for immediate repair, surgeons first redirect more blood through it. The added load stimulates the chamber to grow over months, ideally to a size that supports full repair -- ventricular recruitment. Conversion frees the child from Fontan physiology for life, and up to a third of the \textasciitilde{}1,500 annual US Fontan palliations could be converted. The obstacle is knowing who will benefit. In reported series, 22--46\% of BiV repairs end in circulatory failure, transplant, or death\cite{herrin2017_BiV_clinicalPredict,beattie202_BiV,barry2018_aorticStenosis_BiV}. A recruited ventricle that fails to grow within 6--15 months sends the child back to palliation after an added operation. Today's criteria, heuristic cut-offs of ventricular volume and pressure, measure size but not capability. \bfit{There is a critical need to predict which child will benefit from BiV conversion -- each correct prediction spares a child either a lifetime of Fontan physiology or a futile surgery.}

Our \textbf{long-term goal} is to establish patient-specific Digital Twins (DTs) as decision-support for complex cardiovascular surgery. Our \textbf{objective} is to build a DT for every child in our BiV repair program, \textasciitilde{}50 per year with borderline left or right ventricles, and to test its predictions retrospectively against each child's course. Each DT is built from pre-surgical magnetic resonance imaging with simultaneous pressure measurement (iCMR), and the planned surgery is performed {\it in silico}. We will compare DT parameters with the success of the repair, predicted hemodynamics with the post-operative course, and predicted growth of chamber volume, mass, and wall thickness with the 8--15-month follow-up exam. Our \textbf{central hypothesis} is that \bfit{DT-derived functional parameters, reflecting myocardial health and resilience, identify the children who benefit from BiV conversion better than today's volume and pressure criteria.} It builds on our proof-of-concept DT studies\cite{ruijsink20,gusseva21a,gusseva25} and growth model\cite{gebauer23,gebauer24}. Children's Health at the University of Texas Southwestern Medical Center is one of few US centers performing iCMR routinely and pioneered complex BiV repair. Yale developed the growth model.

\aim{1}{Quantify each patient's cardiovascular physiology before surgery}{
We hypothesize that DT-derived myocardial stiffness and contractility correlate better with successful BiV repair than the directly measured volume and pressure. The ventricular pressure, volume, and outflow data provide A) the standard clinical metrics of end-diastolic volume and pressure, B) internal and external work and ventricular and arterial elastance as surrogates of contractility and circulation resistance, and C) myocardial stiffness and contractility from the DT created on-the-fly during the exam. Aim 1 delivers selection criteria built on the ventricle's capability rather than its size.
}

\aim{2}{Predict the short-term physiology after biventricular repair}{
We hypothesize that the {\it in silico} BiV conversion identifies the patients who develop a non-favorable post-repair physiology. We will modify the Aim 1 DTs for the planned surgery, connecting the borderline ventricle to its target circulation with unchanged flow rate and septated morphology. Contractility, heart rate, preload, and atrio-ventricular valve insufficiency are then varied {\it in silico}. A non-favorable outcome means a heart rate above the age-normal range, an end-diastolic pressure above 15 mmHg, or a required contractility above the pre-conversion level. Aim 2 delivers each child's risk of a failed repair before any incision.
}

\aim{3}{Predict the long-term growth of the recruited ventricle}{
We hypothesize that the recruited ventricle's growth is driven by the altered load and is therefore predictable from the pre-recruitment DT. We will apply our constrained mixture model of cardiac growth,\cite{gebauer23,gebauer24} in which growth emerges from tissue constituent turnover, initialized from the pre-recruitment DT and driven by the post-recruitment loading. Geometry, loading, and wall stress come from each child's iCMR, turnover and gain parameters from established priors. In the recruitment subset, we will test predicted growth against the follow-up exam. Aim 3 delivers the first forecast of whether recruitment will carry a child to repair.
}

The project unites two firsts: cardiovascular physiology assessed on-the-fly during the clinical exam and a mechanistic forecast of ventricular growth. \bfit{If successful, it will replace heuristic size cut-offs with validated, physiology-based selection and timing of BiV conversion: children who can sustain two ventricles escape the Fontan circulation, and children who would not are spared futile operations.} The resulting DTs and criteria will anchor a multi-center trial and a paradigm shift toward digital twins in surgical planning.
